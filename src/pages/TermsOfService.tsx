        ...
        <div className="bg-card p-8 rounded-lg shadow-soft border border-border space-y-8">
          ...
          <section>
            ...
            <div className="space-y-3 text-black">
              ...
              <p><strong>Prijzen en Extra Werk:</strong> De vermelde v.a. prijzen gelden voor goed onderhouden vachten zonder extreme klitten, vervilting of andere uitzonderlijke omstandigheden. Indien tijdens de behandeling blijkt dat er extra werk nodig is, zoals het verwijderen van klitten, vervilting of andere intensieve behandelingen die buiten de standaardbehandeling vallen, zullen de hieraan verbonden extra kosten aan de klant worden doorberekend tegen €60 per uur. Indien wij verwachten dat het extra werk langer dan 15 minuten zal duren, zullen wij dit waar mogelijk van tevoren aangeven of de klant bellen om dit te bespreken. Indien het niet mogelijk is om vooraf contact op te nemen (bijvoorbeeld door tijdsdruk of omdat de omvang van het extra werk pas tijdens de behandeling duidelijk wordt), behouden wij ons het recht voor om de extra kosten alsnog in rekening te brengen.</p>
            </div>
          </section>
